...
|---|---|---|
| 💡 [San Francisco Crime](https://github.com/KevinWongSF/PortfolioProjects/blob/main/San%20Francisco%20Crime%20Analytics) | Data analysis, data processing | This repo serves as the solution for the 8 case studies from the [#8WeekSQLChallenge](https://8weeksqlchallenge.com). It showcases my ability to tackle various SQL challenges and demonstrates my proficiency in SQL query writing and problem-solving skills. | 
